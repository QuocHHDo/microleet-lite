...
const bitmaskDPData: LessonContent = {
  ...
  content: `<div>
<h1>Bitmask DP: Encoding State with Bits</h1>
...
const stateMachineDPData: LessonContent = {
  ...
  content: `<div>
<h1>State Machine DP: Tracking Valid State Transitions</h1>
...
\`\`\`
  ...
  codeExample: `# State Machine DP - Stock with Cooldown
  ...
  exercises: [
    {
      ...
      initialCode: `def max_profit_with_cooldown(prices):
    """
    ...
    # Your code here
    pass`,
      solution: `def max_profit_with_cooldown(prices):
    ...
    },
    {
      ...
      initialCode: `def max_profit_with_fee(prices, fee):
    """
    ...
    # Your code here
    pass`,
      solution: `def max_profit_with_fee(prices, fee):
...
const digitDPData: LessonContent = {
  ...
  content: `<div>
<h1>Digit DP: Working with Digit Constraints</h1>
...
<ul>
  ...
  codeExample: `# Digit DP - Count without digit 4
  ...
  exercises: [
    {
      ...
      initialCode: `def count_without_4(n):
    """
    Count numbers 1 to n without digit 4.
    ...
    # Your code here
    pass`,
      solution: `def count_without_4(n):
    ...
    },
    {
      ...
      initialCode: `def count_divisible_digit_sum(n, k):
    """
    ...
    # Your code here
    pass`,
      solution: `def count_divisible_digit_sum(n, k):
